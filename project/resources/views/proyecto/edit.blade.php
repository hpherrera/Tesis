					...
					<div class="col-md-12">
						...
						<div class="form-group has-feedback {{ $errors->has('Curso') ? 'has-error': '' }}">
							...
							<select class="form-control" name="curso_id">
								@if($proyecto->curso_id == 1)
									<option value="1" selected="">Formulación de Proyecto de Titulación</option>
								@else
									<option value="2" selected="">Proyecto de Tìtulación</option>
								@endif
							</select>
						</div>
						...
						<div class="form-group has-feedback {{ $errors->has('estado_id') ? 'has-error': '' }}">
							<label> Año </label>
							<input id="date_ini" name="year" class="form-control" placeholder="Año" value="{{$proyecto->year}}">
							@if ($errors->has('year'))
							<span class="help-block">
