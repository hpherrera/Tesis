            ...
            <div class="modal-body">
                ...
                <div class="form-group has-feedback {{ $errors->has('hora') ? 'has-error': '' }}">
                    ...
                    <div class="input-group date">
                      ...
                      <input  type="time" class="form-control pull-right" name="hora" id="hora">
                    </div>
                    @if ($errors->has('hora'))
                    <span class="help-block">
            ...
            <div class="modal-body">
                ...
                <div class="form-group has-feedback {{ $errors->has('fecha') ? 'has-error': '' }}">
                    ...
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" name="fechaE" id="fechaE">
                    </div>
                    @if ($errors->has('fecha'))
                    <span class="help-block">
                        <strong>{{ $errors->first('fecha') }}</strong>
                ...
                <div class="form-group has-feedback {{ $errors->has('hora') ? 'has-error': '' }}">
                    ...
                    <div class="input-group date">
                      ...
                      <input  type="time" class="form-control pull-right" name="horaE" id="horaE">
                    </div>
                    @if ($errors->has('hora'))
                    <span class="help-block">
                        <strong>{{ $errors->first('hora') }}</strong>
